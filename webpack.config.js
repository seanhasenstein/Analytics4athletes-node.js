...
// this is our file-loader. It handeles things like css background-images.
const fileLoader = {
  test: /\.(png|jpg)$/,
  use: [
    {
...
// this handles loading SVG as uft-8 encoded DataUrl string.
const svgLoader = {
  test: /\.svg/,
  use: {
...
const config = {
  entry: {
    ...
    App: './public/javascripts/analytics-app.js'
  },
  ...
  module: {
    rules: [javascript, styles, fileLoader, svgLoader]
  },
